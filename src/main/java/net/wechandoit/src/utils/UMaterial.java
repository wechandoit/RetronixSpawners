...
public enum UMaterial implements Versionable {
    ...
    */
    ...
    ;
    private static final HashMap<String, UMaterial> CACHE = new HashMap<String, UMaterial>();
    ...
    public static ItemStack getEnchantmentBook(final Enchantment enchant, final int level, int amount) {
